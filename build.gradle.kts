...
version = "1.0.0" // << The main version should keep consistent with the core module
...
publishing {
    publications {
        create<MavenPublication>("mavenJava") {
            ...
            pom {
                name = project.name
                description = "Enpower Minecraft server with MCP capabilities."
                url = "https://mc-mcp-platform.lunadeer.cn/"
                licenses {
                    license {
                        name = "MIT"
